...
public:
    ...
    backend::Handle<backend::HwTexture> getHwHandleForSampling() const noexcept { return mHandleForSampling; }
    ...
    bool textureHandleCanMutate() const noexcept { return (any(mUsage & Usage::SAMPLEABLE) && mLevelCount > 1) || mExternal; }
